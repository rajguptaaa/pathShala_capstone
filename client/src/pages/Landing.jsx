...
import { BookOpen, Brain, MessageCircle, TrendingUp, Users, Award, Crown } from 'lucide-react';
...
const Landing = () => {
  ...
  const features = [
    ...
    { icon: MessageCircle, title: 'AI Conversation Practice', description: 'Chat with our AI tutor anytime to practice real conversations in your target language.' },
    { icon: TrendingUp, title: 'Track Your Progress', description: 'Visual dashboards and streaks to keep you motivated and on track.' },
    { icon: Users, title: 'Multiple Languages', description: 'Spanish, French, German, Hindi, Japanese, Chinese, and Arabic — all in one place.' },
    { icon: Crown, title: 'Premium Voice Mode', description: 'Upgrade for voice-to-voice AI conversations with real-time pronunciation feedback.' },
  ];
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Why Choose PathShala?</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300">Experience the future of language learning with our cutting-edge features</p>
          </motion.div>
